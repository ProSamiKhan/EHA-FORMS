...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-24 lg:pb-10 bg-[#f8fafc]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 lg:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
             ...
             <button 
                ...
                className="hidden lg:flex items-center gap-2 bg-white text-slate-600 border border-slate-200 px-3 py-2 rounded-xl text-xs font-bold hover:bg-slate-50 transition-all"
             >
             ...
             <button 
                ...
                className="hidden lg:flex bg-indigo-600 text-white px-4 py-2 rounded-xl text-xs font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all items-center gap-2"
             >
      ...
      <div className="lg:hidden bg-white px-4 py-3 border-b border-slate-100 flex gap-2 overflow-x-auto no-scrollbar">
          <button 
            onClick={() => fileInputRef.current?.click()}
          ...
          <button 
            onClick={() => setIsManualModalOpen(true)}
            className="flex-1 bg-white text-slate-700 border border-slate-200 px-4 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-sm flex items-center justify-center gap-2 active:scale-95 transition-transform"
          >
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div className="w-full lg:w-1/4 order-2 lg:order-1 space-y-4 lg:space-y-6">
              <div className="bg-white p-5 lg:p-6 rounded-2xl lg:rounded-3xl shadow-sm border border-slate-200">
                <h2 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">Storage Stats</h2>
              ...
              <div className="space-y-4 lg:space-y-6">
                {filteredRecords.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 lg:py-24 bg-white rounded-2xl lg:rounded-[40px] border border-slate-100 border-dashed">
                    ...
                    <p className="text-slate-400 font-bold text-sm lg:text-base">No registrations found.</p>
                  </div>
                )}
              </div>
            </div>
